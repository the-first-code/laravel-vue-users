<template>    
    <tr>
        ...
        <td class="text-td">
            ...
            <input type="text" style="display: none;" :value="last_name" @change="updateAx(e, 'last_name', this.id)">
        </td>
        <td class="text-td">
            <span @dblclick="update">{{ surname }}</span>
            <input type="text" style="display: none;" :value="surname" @change="updateAx(e, 'surname', this.id)">
        </td>
        <td class="text-td">
        ...
        <td class="text-td">
            ...
            <input type="text" style="display: none;" :value="phone" @change="updateAx(e, 'phone', this.id)">
        </td>
        <td class="text-td">
